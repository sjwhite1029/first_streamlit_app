...
fruitys_selected = streamlit.multiselect("Pick some fruits:", list(my_fruity_list.index), ['Avocado', 'Strawberries'])
fruitys_to_show = my_fruity_list.loc[fruits_selected]
